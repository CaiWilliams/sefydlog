...
def run(EAC4,EGG4,start_date,end_date):
    dates = pd.date_range(start=start_date, end=end_date,freq='3H').to_pydatetime().tolist()
    data = [(EAC4,EGG4,date) for date in dates]
    
    pool = multiprocessing.Pool(processes=64)
    for _ in tqdm.tqdm(pool.imap_unordered(get_map,data), total=len(dates)):
         pass
...
if __name__ == '__main__':
    ...
    EAC4 = 'EAC4_2007.grib'
    EGG4 = 'EGG4_2007.grib'
    start_date =  datetime.datetime(2007,1,1,0)
    end_date = datetime.datetime(2007,12,31,21)
    run(EAC4,EGG4,start_date,end_date)
    ...
    #EGG4 = 'EGG4_2005_SeaLevel.grib'
    #start_date =  datetime.datetime(2005,1,1,0)
    #end_date = datetime.datetime(2005,12,31,21)
    #run(EAC4,EGG4,start_date,end_date)
    
    #EAC4 = 'EAC4_2006_SeaLevel.grib'
    #EGG4 = 'EGG4_2006_SeaLevel.grib'
    #start_date =  datetime.datetime(2006,1,1,0)
    #end_date = datetime.datetime(2006,12,31,21)
    #run(EAC4,EGG4,start_date,end_date)