...
def spacial(dir, start_date, end_date, step):
    ...
    fig.text(0.03, 0.65, '2020-1-1', va='center', rotation='vertical', fontsize=9)
    fig.text(0.825, 0.35, '2020-1-6', va='center', rotation='vertical', fontsize=9)
    cbar = fig.colorbar(cs,cax=cbar_ax,orientation='vertical',label='Electrical Power Loss (Wm$^{-2}$)',ticks=[0,-10,-20,-30,-40,-50])
    return
 
spacial('Australia','1/1/2020','6/01/2020',24)
plt.show()
#plt.savefig('Australia_Spacial_2020.png',dpi=600)
