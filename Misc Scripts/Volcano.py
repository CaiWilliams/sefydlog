...
#data = calc_multiyear(['Beijing'],dt.datetime(day=1,month=1,year=2008,hour=0),dt.datetime(day=1,month=12,year=2008,hour=0))
data = calc_multiyear(['Durham'],dt.datetime(day=20,month=3,year=2010,hour=0)-dt.timedelta(days=8),dt.datetime(day=23,month=6,year=2010,hour=0)+dt.timedelta(days=8))
