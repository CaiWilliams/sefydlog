...
#data = calc_multiyear(['Beijing_Power'],dt.datetime(day=1,month=1,year=2008,hour=0),dt.datetime(day=31,month=12,year=2008,hour=0))
data = calc_multiyear(['Beijing_Power'],dt.datetime(day=8,month=7,year=20,hour=0),dt.datetime(day=24,month=9,year=2008,hour=0)+dt.timedelta(days=8))
#plt.plot(data['Power']*1e9)
plt.plot(data['Energy_Loss'].rolling(8*2).mean())
#plt.twinx()
