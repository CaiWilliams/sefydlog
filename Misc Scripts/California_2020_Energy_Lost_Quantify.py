...
def spacial(dir, start_date, end_date, step, locs):
    ...
    for i in range(len(locs_names)):
        ...
        ax[i].plot(dates_of_data_list[dates_idx[0]:dates_idx[-1]],np.cumsum(energy_loss_sum),color=colours[i])
        print(locs_names[i])
...
spacial('California','16/08/2020','12/11/2020','3','CaliforniaLocs')
plt.show()
