...
def spacial(dir, start_date, end_date, step, locs,noct):
    ...
    data = np.clip(data,a_min=0,a_max=100000)
    #data = data[dates_idx]
...
def plot_curtailment(gen):
    ...
    temp = temp.resample('3h').mean()
    temp = temp[(temp.index >= dt.datetime(2020, 1, 1, 12)) & (temp.index <= dt.datetime(2020, 12, 31, 12))]
...
#spacial('California_SolarFarms','1/1/2020','31/12/2020','24','California_SolarFarms',20)
dates, data, power_cal = spacial('California_SolarFarms','17/8/2020','11/11/2020','3','California_SolarFarms',40)
print(len(data))
