...
L, X, dates = spacial('California', '1/01/2020', '31/12/2020', 3)
...
plt.plot(dates[::], area[::] * 80**2 / 423970 * 100)
plt.ylabel('Percent of Land in California Affected (%)')
plt.xlim(left=dt.datetime(2020,1,1,12),right=dt.datetime(2021,1,1,12))
