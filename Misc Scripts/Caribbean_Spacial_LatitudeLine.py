...
longitudes_unique,mean_lon,std_lon = spacial_Long('EuropeNAmerica_LongitudeLine','12/06/2020','24/06/2020',24,10,15)
ax1.plot(longitudes_unique, mean_lon)

#ax1.fill_between(longitudes_unique, mean_lon - std_lon, mean_lon + std_lon, alpha=0.25)

longitudes_unique,mean_lon,std_lon = spacial_Long('EuropeNAmerica_LongitudeLine','12/06/2020','24/06/2020',24,15,20)
ax1.plot(longitudes_unique, mean_lon)

#ax1.fill_between(longitudes_unique, mean_lon - std_lon, mean_lon + std_lon, alpha=0.25)

longitudes_unique,mean_lon,std_lon = spacial_Long('EuropeNAmerica_LongitudeLine','12/06/2020','24/06/2020',24,20,25)
ax1.plot(longitudes_unique, mean_lon)
