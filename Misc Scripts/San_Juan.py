...
data = calc_multiyear(['San_Jaun_Puerto_Rico'],dt.datetime(day=1,month=1,year=2015,hour=12),dt.datetime(day=31,month=12,year=2020,hour=12))
plt.plot(data['Energy_Loss'].clip(upper=0).rolling(8*7*4).mean())
...
plt.ylim(top=0)
plt.savefig('SanJuan.png',dpi=600)
#plt.twinx()
