...
def covid_Durham():
    x1,y1 = calc_power_diff('P3HTPCBM_Durham_Pristine_2020','P3HTPCBM_Durham_2020')
    x2,y2 = calc_power_diff('P3HTPCBM_Durham_Pristine_2019','P3HTPCBM_Durham_2019')
    plt.plot(x2[:8746],y1[:8746]-y2[:8746])
...
plot('P3HTPCBM_Reykjavik_SDM_2009')
# covid_Mexico_City()
